...
import images from '@/assets/image/bguseraccount.jpeg';
    ...
    return (
        <div className={cx('container-fluid', 'ps-0', 'pe-0')} style={{ height: '100vh', overflowY: 'auto' }}>
            <div className={cx('row', 'h-100')}>
                <div className={cx('col-md-4', 'ps-0', 'pe-0')}>
                    <div className={cx('w-100', 'h-100')} style={{ padding: '48px' }}>
                        ...
                        <div className={cx('w-100')}>
                            ...
                            <div className={cx('form-group')}>
                                <p className={cx('fs-6', 'text-center')}>
                                    Việc bạn tiếp tục sử dụng trang web này đồng nghĩa bạn đồng ý với{' '}
                                    <span className={cx('text-color-app')}>Điều khoản sử dụng</span> của chúng tôi.
                                </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className={cx('col-md-8', 'ps-0', 'pe-0', 'h-100', 'd-none', 'd-md-block')}>
                    <div className={cx('w-100', 'h-100', 'p-2')}>
                        <div
                            style={{
                                background: `url(${images}) center center / cover no-repeat border-box border-box`,
                            }}
