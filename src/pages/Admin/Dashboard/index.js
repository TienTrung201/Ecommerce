...
function Dashboard() {
  return (
    <>
      <div className={cx('page-header', 'align-items-center')}>
        <h3 className={cx('page-title', 'd-flex', 'align-items-center', 'm-0')}>
          <span className={cx('page-title-icon', 'bg-gradient-primary', 'text-white', 'me-2')}>
            <i className={cx('mdi')}>
              ...
              <div className={cx('table-responsive')}>
                <table className={cx('table')}>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img src={images.faces.face1} className={cx('me-2')} alt="" /> David Grey
                      </td>
                    ...
                    <tr>
                      <td>
                        <img src={images.faces.face2} className={cx('me-2')} alt="" /> Stella Johnson
                      </td>
                      <td> High loading time </td>
                      <td>
                        <label className={cx('badge', 'badge-gradient-warning')}>PROGRESS</label>
                      </td>
                      <td> Dec 12, 2017 </td>
                      <td> WD-12346 </td>
                    </tr>
                    <tr>
                      <td>
                        <img src={images.faces.face3} className={cx('me-2')} alt="" /> Marina Michel
                      </td>
